...
namespace TestEasyGenerator
{
    ...
    public class ForeignKeyReferenceInfoTest
    {
        ...
        public void ForeignKeyReferenceInfoConstructorTest()
        {
            ...
            ColumnInfo actual2 = (ColumnInfo)xmlSerializer.Deserialize(new StringReader(writer.ToString()));
            Assert.AreEqual("column1", actual2.References.Values[0].ColumnName);
